...
<div id="main_skeleton_joint_div" style="width:1070px; height:788px;">
        <div style="width:675px; overflow: hidden; float:left;">
	        <img id="body_hand_foot_image" src="<?php echo base_url(); ?>assets5/body_hand_foot_highlights_75p.jpg" width="675" height="788" usemap="#joint_map_name" alt="Skeleton joint image" />
        </div>
