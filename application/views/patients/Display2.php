...
<section class="content">
  ...
  <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Patients/Edit2/<?php echo $patient_data->id; ?>">
    <span>Edit</span>     
  </span>
</a>
...
if($status == "deactivated"){?>
 ...
 <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Patients/Activate2/<?php echo $patient_data->id; ?>">
  <span>Activate</span>     
</span>
</a> 
...
<a class="btn btn-primary btn-block" href="<?php echo base_url();?>Patients/home">
  <span>Home</span>     
</span>
</a>
