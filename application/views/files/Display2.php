...
<section class="content">
  <div class="row">
    ...
    <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Files/Edit2/<?php echo $file_data->id; ?>">
      <span>Edit</span>            
    </a> 
          ...
          <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Files/Download2/<?php echo $file_data->id; ?>">
            <span>Download</span>            
          </a>
          ...
          <?php foreach($status as  $s):?>  
           ...
           if($status == "activated"){?>
            ...
            <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Files/Archive2/<?php echo $file_data->id; ?>">
              <span>Archive</span>            
            </a> 
          ...
          if($status == "deactivated"){?>
           ...
           <a class="btn btn-primary btn-block margin-bottom" href="<?php echo base_url();?>Files/Activate2/<?php echo $file_data->id; ?>">
            <span>Activate</span>            
          </a> 
