    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          ...
          <a class="btn btn-primary btn-block margin-bottom" href="<?php echo base_url();?>Files/Archive/<?php echo $file_data->id; ?>">
            <span>Archive</span>     
            </span>
          </a>
       ...
       <div class="col-md-9">
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
                   ...
                   <?php echo form_open('Files/edit/'. $file_data->id . '', $attributes);?>
