  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn-block margin-bottom" href="<?php echo base_url();?>Accounts">
            <span>Home</span>     
            </span>
          </a> 
          ...
          <div class="col-md-9">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
               ...
               <?php echo form_open('Accounts/edit/'. $account_data->id . '', $attributes);?>
         ...
         <div class="form-group">
               ...
               <?php echo form_dropdown('role_id', $data, $account_data->role_id
             ); ?>
           </div> 
	 ...
	 <div class="form-group">
                 ...
                 <?php echo form_dropdown('status', $data); ?>
               </div> 
