  ...
  <section class="content">
    <div class="row">
      <div class="col-md-3">
       <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Accounts">
        <span>Home</span>     
      </a>

      <a class="btn btn-primary btn-block margin-bottom" href="<?php echo base_url();?>Accounts/Edit/<?php echo $account_data->id; ?>">
        <span>Edit</span>            
      </a> 
            ...
            <div class="col-md-9">
              <div class="panel panel-primary">
                ...
                <div class="panel-body">
                  ...
                  <hr>
		    <p><strong>Status:</strong> <?php echo $account_data->status; ?></p>
                   <hr>
