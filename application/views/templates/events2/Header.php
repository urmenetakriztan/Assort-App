...
<head>
  ...
  <!-- fullCalendar -->
  <link href="<?php echo base_url();?>assets4/css/fullcalendar.css" rel="stylesheet" />
  <link href="<?php echo base_url();?>assets4/css/bootstrapValidator.min.css" rel="stylesheet" />        
  <link href="<?php echo base_url();?>assets4/css/bootstrap-colorpicker.min.css" rel="stylesheet" />
  <!-- Custom css  -->
  <!-- <link href="<?php echo base_url();?>assets4/css/custom.css" rel="stylesheet" />  -->
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <aside class="main-sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="">
        <a href="<?php echo base_url();?>Patients/home">
      ...
      <li>
        <a href="<?php echo base_url();?>Files/home">
      ...
      <li class="">
        <a href="<?php echo base_url();?>Equipments/home">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="<?php echo base_url();?>Activity/home"><i class="fa fa-circle-o"></i> Activity Log</a></li>
          <li><a href="<?php echo base_url();?>Help/home"><i class="fa fa-circle-o"></i> Help</a></li>
          <li><a href="<?php echo base_url();?>About/home"><i class="fa fa-circle-o"></i> About</a></li>
        </ul>
      </li>          
    </ul>
  </section>
