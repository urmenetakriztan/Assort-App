  ...
  <section class="content">
    <div class="row">
      ...
      <a class="btn btn-primary btn-block margin-bottom" href="<?php echo base_url();?>Equipments/Archived2">
        <span>Archived</span>     
      </span>
    </a>
            ...
            <tbody role="alert" aria-live="polite" aria-relevant="all">
             ...
             <?php foreach($equipments as $equipment): ?> 
              <tr>
                ...
                <?php echo "<td> <a href='" .base_url()."Equipments/Display2/$equipment->id'>" .
