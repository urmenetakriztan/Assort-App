  ...
  <section class="content">
    <div class="row">
      <div class="col-md-3">
      <!--  <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Equipments/Add2">
        <span>Add</span>     
      </a> -->

     <!--  <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Equipments/Edit2/<?php echo $equipment_data->id; ?>">
        <span>Edit</span>            
      </a> -->

     <!--  <a class="btn btn-primary btn-block" href="<?php echo base_url();?>Equipments/Archive2/<?php echo $equipment_data->id; ?>">
        <span>Archive</span>            
      </a> -->

      <!-- <a class="btn btn-primary btn-block margin-bottom" href="<?php echo base_url();?>Equipments/Activate2/<?php echo $equipment_data->id; ?>">
        <span>Activate</span>            
      </a> -->
